...
int main(void)
{
  ...
  export_Addresses(Address_GPIOs);
  set_direction(Address_GPIOs);
  ...
  do {
    ...
    for (int i = 0; i < 16; i++) {
        sprintf(buff, "/sys/class/gpio/gpio%d/value", Address_GPIOs[i]);
  ...
  unexport_Addresses(Address_GPIOs);
